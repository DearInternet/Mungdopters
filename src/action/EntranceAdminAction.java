...
import svc.EntranceAdminService;
import vo.ActionForward;
import vo.BoardBean;
import vo.EntranceBean;
import vo.PageInfo;

 public class EntranceAdminAction implements Action {
	 ...
	 public ActionForward execute(HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		EntranceAdminService entranceAdminService = new EntranceAdminService();
		int listCount=entranceAdminService.getEntranceListCount();
		// select count(*) from board_ask 총 리스트 수를 받아옴.
		
		articleList = entranceAdminService.getArticleList(page); 
		...
		ActionForward forward= new ActionForward();
   		forward.setPath("./Entrance_Admin.jsp");
   		return forward;
